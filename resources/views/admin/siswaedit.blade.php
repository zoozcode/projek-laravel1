...
<body>
    <div class="container">
        ...
        <main>
            <h1>Siswa</h1>
            <form action="/admin/siswaupdate" method="post">
                @csrf
                <input type="hidden" name="id" value="{{ $siswa->id }}">
                <p>nis <input type="number" name="nis" class="form-control my-2" value="{{ $siswa->nis }}"></p>
                <p>nama <input type="text" name="nama" class="form-control my-2"  value="{{ $siswa->nama }}"></p>
                <p>kelas <input type="kelas" name="kelas" class="form-control my-2"  value="{{ $siswa->kelas }}"></p>
